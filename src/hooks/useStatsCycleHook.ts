...
import { getFormattedStat, getStatOptions, OverviewStatsKeys, StatOption } from "../utils/haloStatFormatter";

export const useStatsCycleHook = (
  keys: OverviewStatsKeys[],
  stats: OverviewStats | null | undefined,
  interval: number,
): [null | StatOption, null | string | number] => {
